...
```bash
# Base model
mlx_lm.generate --model zen-coder/mlx --prompt "Your prompt here"

# 4-bit model (fastest)
mlx_lm.generate --model zen-coder/mlx-4bit --prompt "Your prompt here"

# 8-bit model
mlx_lm.generate --model zen-coder/mlx-8bit --prompt "Your prompt here"
```
...
model, tokenizer = load("zen-coder/mlx-4bit")
